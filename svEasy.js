...
const quiz = [
    {
        "Question": "What is SystemVerilog primarily used for?",
        "options": {
            "A": "Web development",
            "B": "Hardware design and verification",
            "C": "Database management",
            "D": "Network administration"
        },
        "correctAnswer": "B",
        "Explanation": "SystemVerilog is an extension of Verilog, mainly used for hardware design and verification in the field of electronic design automation (EDA)."
    },
    {
        "Question": "Which of the following is a data type in SystemVerilog?",
        "options": {
            "A": "int",
            "B": "real",
            "C": "bit",
        ...
        "correctAnswer": "D",
        "Explanation": "SystemVerilog supports multiple data types, including int, real, and bit."
    },
    {
        "Question": "In SystemVerilog, which keyword is used to define a module?",
        "options": {
            "A": "package",
            "B": "class",
            "C": "module",
        ...
        "correctAnswer": "C",
        "Explanation": "The module keyword is used to define a module in SystemVerilog."
    },
    {
        "Question": "What does the always_ff block in SystemVerilog specify?",
        "options": {
            "A": "Combinational logic",
            "B": "Sequential logic",
            "C": "Asynchronous logic",
            "D": "Continuous assignments"
        },
        "correctAnswer": "B",
        "Explanation": "The always_ff block in SystemVerilog is used to specify sequential logic."
    },
    {
        "Question": "Which of the following is used to declare an enumerated type in SystemVerilog?",
        "options": {
            "A": "typedef",
            "B": "enum",
            "C": "class",
        ...
        "correctAnswer": "B",
        "Explanation": "The enum keyword is used to declare an enumerated type in SystemVerilog."
    },
    {
        "Question": "What is the primary purpose of assertions in SystemVerilog?",
        "options": {
        ...
        "correctAnswer": "B",
        "Explanation": "Assertions in SystemVerilog are primarily used for functional verification to ensure that the design behaves as expected."
    },
    {
        "Question": "Which keyword is used to define a class in SystemVerilog?",
        "options": {
            "A": "struct",
            "B": "class",
            "C": "module",
        ...
        "correctAnswer": "B",
        "Explanation": "The class keyword is used to define a class in SystemVerilog."
    },
    {
        "Question": "What is the function of the typedef keyword in SystemVerilog?",
        "options": {
            "A": "To define a new data type",
            "B": "To create an alias for an existing data type",
            "C": "To initialize a variable",
            "D": "To start a simulation"
        },
        "correctAnswer": "B",
        "Explanation": "The typedef keyword is used to create an alias for an existing data type in SystemVerilog."
    },
    {
        "Question": "In SystemVerilog, what is a struct used for?",
        "options": {
            "A": "To define a module",
            "B": "To create a function",
            "C": "To group related data types",
            "D": "To declare a signal"
        },
        "correctAnswer": "C",
        "Explanation": "A struct in SystemVerilog is used to group related data types together."
    },
    {
        "Question": "Which of the following is not a built-in integer type in SystemVerilog?",
        "options": {
            "A": "byte",
            "B": "shortint",
            "C": "real",
        ...
        "correctAnswer": "C",
        "Explanation": "real is a floating-point type, not an integer type in SystemVerilog."
    },
    {
        "Question": "What does the logic data type in SystemVerilog represent?",
        "options": {
            "A": "A four-state data type",
            "B": "A two-state data type",
            "C": "A floating-point number",
            "D": "An enumerated type"
        },
        "correctAnswer": "A",
        "Explanation": "The logic data type in SystemVerilog represents a four-state data type (0, 1, X, Z)."
    },
    {
        "Question": "Which construct is used to create a hierarchical design in SystemVerilog?",
        "options": {
            "A": "function",
            "B": "class",
            "C": "module",
        ...
        "correctAnswer": "C",
        "Explanation": "Modules are used to create hierarchical designs in SystemVerilog."
    },
    {
        "Question": "What is the purpose of a parameter in SystemVerilog?",
        "options": {
            "A": "To declare a variable",
            "B": "To define a constant value",
            "C": "To control simulation time",
            "D": "To initiate a process"
        },
        "correctAnswer": "B",
        "Explanation": "A parameter in SystemVerilog is used to define a constant value that can be used throughout the module."
    },
    {
        "Question": "Which of the following is a method used to define an interface in SystemVerilog?",
        "options": {
            "A": "class",
            "B": "module",
            "C": "interface",
        ...
        "correctAnswer": "C",
        "Explanation": "The interface keyword is used to define an interface in SystemVerilog."
    },
    {
        "Question": "In SystemVerilog, what is the purpose of the initial block?",
        "options": {
            "A": "To define continuous assignments",
            "B": "To initialize variables and execute statements at the start of simulation",
            "C": "To handle clock signals",
            "D": "To perform real-time updates"
        },
        "correctAnswer": "B",
        "Explanation": "The initial block in SystemVerilog is used to initialize variables and execute statements at the start of the simulation."
    }
]
