...
const quiz =[
    {
      "question": "For a common-emitter amplifier with an emitter resistor (Re), the voltage gain (Av) is given by?",
      "options": {
        "A": "Av = Rc / (re + Re)",
        "B": "Av = Rc / Re",
        "C": "Av = Rc / re",
      ...
      "correct_answer": "B",
      "explanation": "The voltage gain of a common-emitter amplifier with an emitter resistor is given by Av = Rc / (re + Re), where re is the internal emitter resistance and Re is the external emitter resistor. This formula accounts for emitter degeneration, which reduces the voltage gain compared to when no emitter resistor is used."
    },
    {
      "question": "In a differentiator circuit using an op-amp, the output voltage is:",
      "options": {
        "A": "Directly proportional to the input voltage",
        "B": "The integral of the input voltage",
        "C": "The derivative of the input voltage",
        "D": "The square of the input voltage"
      },
      "correct_answer": "C",
      "explanation": "An op-amp differentiator produces an output voltage that is the time derivative of the input voltage. The output is proportional to the rate of change of the input signal with respect to time."
    },
    {
      "question": "The frequency response of a second-order low-pass filter is given by the following transfer function H(s) = 1 / (s^2 + 2s + 1). The natural frequency (ω₀) and damping factor (ζ) are:",
      "options": {
        "A": "ω₀ = 1, ζ = 2",
        "B": "ω₀ = 1, ζ = 0.5",
        "C": "ω₀ = 2, ζ = 1",
      ...
      "correct_answer": "D",
      "explanation": "The transfer function H(s) = 1 / (s^2 + 2s + 1) is of the form 1 / (s^2 + 2ζω₀s + ω₀^2), where ω₀ is the natural frequency and ζ is the damping factor. Comparing coefficients, we get ω₀ = 1 and ζ = 1, indicating a critically damped system."
    },
    {
      "question": "The input impedance of an ideal op-amp in a non-inverting amplifier configuration is?",
      "options": {
        "A": "Very high",
        "B": "Very low",
        "C": "Infinite",
        "D": "Finite but less than the feedback resistor"
      },
      "correct_answer": "A",
      "explanation": "In a non-inverting amplifier configuration, the input impedance is ideally infinite because the op-amp's non-inverting input draws no current, and the impedance between the input and the op-amp is very high."
    },
    {
      "question": "In an amplifier, the value of the gain-bandwidth product (GBP) is constant. If the gain of the amplifier is halved, the bandwidth will?",
      "options": {
        "A": "Increase",
        "B": "Decrease",
        "C": "Remain the same",
      ...
      "correct_answer": "A",
      "explanation": "The gain-bandwidth product (GBP) is constant for a given amplifier. If the gain is reduced, the bandwidth must increase to maintain the constant GBP. Conversely, if the gain increases, the bandwidth will decrease."
    }
  ]
