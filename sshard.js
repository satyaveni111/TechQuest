...
const quiz = [
    {
      "question": "The Laplace transform of the signal x(t)=e^−2tsin(3t)u(t) is?",
      "options": {
        "A": "s+2/(s+2)^2+9",
        "B": "−2/(s−2)^2+9",
        "C": "3/(s^2+9)",
      ...
      "correct_answer": "B",
      "explanation": "The Laplace transform of a function of the form e^at sin(bt)u(t) is given by b/[(s-a)^2+b^2]. For x(t)=e^−2t sin(3t)u(t), a=−2 and b=3. Substituting these values, we get the Laplace transform as −2/[(s+2)^2+9]."
    },
    {
      "question": "The Fourier transform of a rectangular pulse of width T is?",
      "options": {
        "A": "T sin(ωT/2)/(ωT/2)",
        "B": "T δ(ω)",
        "C": "T/2 δ(ω)",
      ...
      "correct_answer": "A",
      "explanation": "The Fourier transform of a rectangular pulse results in a sinc function. Specifically, the Fourier transform of a rectangular pulse of width T is T sin(ωT/2)/(ωT/2), which represents a sinc function in the frequency domain."
    },
    {
      "question": "Which of the following is true for a system characterized by the transfer function H(s)= (s+2)/(s^2+3s+2)?",
      "options": {
        "A": "The system is stable and behaves like a low-pass filter.",
        "B": "The system is stable and behaves like a high-pass filter.",
        "C": "The system is unstable and behaves like a high-pass filter.",
        "D": "The system is unstable and behaves like a low-pass filter."
      },
      "correct_answer": "B",
      "explanation": "The poles of the system are at s=−1 and s=−2, which are in the left half of the s-plane, meaning the system is stable. The zero at s=−2 and the structure of the transfer function indicate a high-pass filter behavior."
    },
    {
      "question": "If the impulse response of a system is h(t)=e^−2t u(t), what is the output of the system for an input x(t)=cos(t)u(t)?",
      "options": {
        "A": "(1/3)e^−2t sin(t)u(t)",
        "B": "(1/5)e^−2t sin(t)u(t)",
        "C": "(2/5)e^−2t sin(t)u(t)",
        "D": "(1/4)e^−2t cos(t)u(t)"
      },
      "correct_answer": "A",
      "explanation": "The output of the system is the convolution of the input x(t) with the impulse response h(t). Convolution of e^−2t u(t) and cos(t)u(t) results in a decaying sinusoidal function, yielding the factor (1/3)."
    },
    {
      "question": "For the discrete-time signal x[n]=(0.5)^n u[n], the Z-transform is?",
      "options": {
        "A": "1/(1−0.5z^−1)",
        "B": "1/(1+0.5z^−1)",
        "C": "1/(1−0.5z)",
      ...
      "correct_answer": "A",
      "explanation": "The Z-transform of x[n]=(0.5)^n u[n] is 1/(1−0.5z^−1), derived from the standard Z-transform of a geometric series."
    },
    {
      "question": "The transfer function of an LTI system is given as H(s)= 10/(s^2 +6s+10). What is the damping factor of the system?",
      "options": {
        "A": "0.6",
        "B": "0.5",
        "C": "0.7",
      ...
      "correct_answer": "A",
      "explanation": "For the second-order system H(s)= 10/(s^2 +6s+10), the damping factor ζ is given by the coefficient of s divided by 2√(coefficient of the constant term). Substituting values, ζ=6/(2√10)=0.6."
    },
    {
      "question": "The impulse response of a continuous-time system is given by h(t)=e^−2t u(t). What is the Laplace transform of h(t)?",
      "options": {
        "A": "1/(s+2)",
        "B": "1/(s−2)",
        "C": "2/(s+2)",
      ...
      "correct_answer": "A",
      "explanation": "The Laplace transform of h(t)=e^−2t u(t) is 1/(s+2), a standard result for the Laplace transform of a decaying exponential multiplied by the unit step function."
    },
    {
      "question": "Which of the following is a property of an ideal differentiator?",
      "options": {
        "A": "It has a flat frequency response.",
        "B": "It amplifies low-frequency components.",
        "C": "It has a frequency response that increases linearly with frequency.",
        "D": "It has a frequency response that decreases with frequency."
      },
      "correct_answer": "C",
      "explanation": "The frequency response of an ideal differentiator is H(jω)=jω, which increases linearly with frequency."
    }
  ]
